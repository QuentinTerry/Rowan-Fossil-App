...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        theme: ThemeData(
          backgroundColor: Color.fromARGB(255, 87, 21, 11),
        ),
        ...
        routes: <String, WidgetBuilder>{
          ...
          "FourthPage": (BuildContext context) => new Fourth(),
          "FifthPage": (BuildContext context) => new Fifth(),
          "SixthPage": (BuildContext context) => new Sixth(),
          "SeventhPage": (BuildContext context) => new Seventh(),
          "Screen1Page": (BuildContext context) => new Screen1(),
          "Screen2Page": (BuildContext context) => new Screen2(),
          "Screen3Page": (BuildContext context) => new Screen3()
        });
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var headerText = new Text('RU Family Weekend \n ' + "Sept 28 - 30, 2018");

    var header = new DrawerHeader(child: headerText,decoration: BoxDecoration(
      color: Color.fromARGB(255, 255, 204, 0),),);

    /**** 1st Drawer Item ****/
    var item1Text = new Text('General info');

    var item1Icon = new Icon(Icons.info);

    var item1 = new ListTile(
        title: item1Text, leading: item1Icon, onTap: _onItem1OnTap);

    /**** 2nd Drawer Item ****/
    var item2Text = new Text('Sponsors');

    var item2Icon = new Icon(Icons.web);
    ...
    var item3Text = new Text('Website');

    var item3Icon = new Icon(Icons.schedule);
    ...
    var item4Text = new Text('Tickets');

    var item4Icon = new Icon(Icons.local_offer);
    ...
    var item5Icon = new Icon(Icons.sms);
    ...
    var item6Icon = new Icon(Icons.chat);
    ...
    var item7Text = new Text('Schedule');

    var item7Icon = new Icon(Icons.chat);

    var item7 = new ListTile(
        title: item7Text, leading: item7Icon, onTap: _onItem7OnTap);

    var children = [header, item1, item2, item3, item4, item5, item6, item7 ];
    ...
    return new Scaffold(
      drawer: drawer,
      appBar: new AppBar(
        title: new Text('RU Family Weeekend'), backgroundColor: Color.fromARGB(255, 87, 21, 11),
      ),
        backgroundColor: Color.fromARGB(255, 255, 204, 0),
      body: new Center(
          child: new Column(
              children: <Widget>[
                Image.asset('assets/images/rufwpic.png', width: 375.0, height: 264.0,),
                Text("2018 Family Weekend",textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 36.0, color: Color.fromARGB(255, 87, 21, 11))),
                Text("General info", textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 36.0, color:Color.fromARGB(255, 87, 21, 11))),
                new Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[

                    Text("Click Below for information, Schedule and Tickets", textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 14.0, color:Color.fromARGB(255, 87, 21, 11))),
                  ],
                )
              ])));
  }
  ...
  void _onItem6OnTap() {
    Navigator.of(context).pushNamed("SixthPage");
  }
  void _onItem7OnTap() {
    Navigator.of(context).pushNamed("SeventhPage");
  }
...
class First extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(appBar: new AppBar(
      title: new Text('General Information'), backgroundColor: Color.fromARGB(255, 87, 21, 11),
...
final titles = ['Alumni Engagement', 'Athletics', 'Barnes & Noble', 'Edelman Planetarium', 'GourmetDining', "Harley E. Flack Student Mentoring Program", "History Department", "Office ofCareer Advancement", "Social Justice, Inclusion & Conflict Resolution", "Orientation &Student Leadership Programs", "Parent & Family Connections", "Rohrer College ofBusiness", "Rowan University Art Gallery", "Rowan After Hours", "Chamberlain StudentCenter & Campus Activities", "Campus Recreation",
"WGLS-FM Radio Station", "Museum of Anthropology at Rowan University", "EdelmanFossil Park", "College of Performing Arts", "Wellness Center", "Veterans Affairs", "GreekLife"];
...
class Second extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('2018 Family Weekend Sponsors'), backgroundColor: Color.fromARGB(255, 87, 21, 11),
        ...
        ListView.separated(
          ...
          separatorBuilder: (context, position) {
            return Divider(
              color: Color.fromARGB(255, 87, 21, 11),
              height: 20.0,
            );
          },
...
class Third extends StatelessWidget {
 ...
 // Completer<WebViewController> _controller = Completer<WebViewController>();
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          title: new Text("Website"), backgroundColor: Color.fromARGB(255, 87, 21, 11)),
...
class Fourth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          title: new Text("Tickets"), backgroundColor: Color.fromARGB(255, 87, 21, 11)),
      body: new WebviewScaffold(
...
class Fifth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
          title: new Text("Facebook"), backgroundColor: Color.fromARGB(255, 87, 21, 11)),
      body: new WebviewScaffold(
...
class Seventh extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('2018 Family Weekend Schedule'), backgroundColor: Color.fromARGB(255, 87, 21, 11),
          ...
          child: new Row(
            ...
            children: [
              RaisedButton(onPressed: () {
                Navigator.of(context).pushNamed("Screen1Page");
              }, child : const Text('28TH')),
              RaisedButton(onPressed: () {
                Navigator.of(context).pushNamed("Screen2Page");
              }, child : const Text('29TH')),
              RaisedButton(onPressed: () {
                Navigator.of(context).pushNamed("Screen3Page");
...
class Screen1 extends StatelessWidget {
  final events_fri =["Registration and Welcome", "5 Friday at the Glassworks Eatery", "How to Create a Killer LinkedIn Profile That Will Get You Noticed",
  ...
  final desc_fri = ["Time: 4:00pm - 7:00pm \n Location: Atrium, Savitz Hall 2nd Floor \n Students or family members can pick up their reserved tickets or purchase tickets while supplies last.  We encourage guests to bring non-perishable food and toiletries donations for The Shop at Rowan" +
      ...
      "profile in a way that appeals to prospects that are quickly scanning to see if you have what they need.  ", "Time: 4:00pm - 7:00pm\n Location: Rowan University Art Gallery, 301 West High Street, Glassboro NJ\n Cost: Free\n Rowan University art " +
      ...
      " the mainstream fashion and design sectors.  Artist Heather Ujiie's work speaks directly to issues that are currently relevant in our society: transgender, sexuality, environmental issues, science and technology.  ", "Time: 5:30pm - TBA\n Location: Hollydell Ice Arena, 600 Hollydell Drive, Sewell NJ\n Cost: 5 - Adults, Free- Rowan Students(With ID) and children(Athletic passes included by the Athletic Department cannot be used for this event.)\n " +
      ...
      "a free shuttle will be provided from the Student Center Half-Circle starting at 8:30pm.  Enjoy free food and drinks while you watch.  ", "Time: 10:00pm - TBA\n Location: Edelman Planetarium, Science Hall\n Cost: 5 - Adults, 3 - Children and Senior Citizens (Under 16 and over 60), 3 - Rowan Students (With ID)\n " +
      "Show details and ticket purchases can be found at www.rowan.edu/planetarium"];
  final events_sat = ["Registration and Welcome", "The SHOP (Students Helping Other Profs) Food Pantry Donations","They Fought We Ride, Run, or Walk", "MARU (Museum of Anthropology at Rowan University) Tour", "WGLS-FM Radio Studio Tour", "Heather Ujii: Dystopian Garden Paradise",
  "Story Telling and Craft Time at Barnes and Noble", "Instrument Petting Zoo", "Ingredients for a Great Career: Exploring OCA Services and Resources", "Family Block Party/Vendor Fair", "Flu Shots", "Sweets in the Sukkah", "Hollybush Tour", "Rowan University Field Hockey vs. William Patterson University",
  "Profecy A Cappella Performance", "Liquid Nitrogen Ice Cream Demonstration", "Rowan Family Fossil Find", "Finance Lab Demonstration", "Black Holes - Planetarium Show", "Stars of the Pharaohs - Planetarium Show", "Rowan University Football vs. Christopher Newport University",
  "Rowan University Men's Soccer vs. Kean University", "Laser Queen - Planetarium Show", "Laser Queen - Planetarium Show", "End of Summer Bingo", "Laser Queen - Planetarium Show"];

  final events_sun = ["A Service of Many Faiths", "Black Jack Walk", "Sweet and Savory Brunch at the Glassworks Eatery", "Hollybush Tour", "Family Show - Planetarium Show", "Stars of the Pharaohs - Planetarium Show"];

  final desc_sat = ["Time: 9:00am - 12:30pm\n Location: The Registration Tent, Athletic Alumni Patio, Between the End Zone and John Green Team House\n Cost: Free\n " +
      ...
      "Tune up your bicycle or lace up your running/walking shoes and participate in our veterans event!  A fun bike/run/walk that serves as a fundraiser for our veterans' initiatives.  the course follows the perimeter of our campus.  ", "Time: 10:00am - 4:00pm\n Location: Robinson Hall, Room 205\n Cost: Free\n " +
                ...
                "and even an extensive human evolution series inaugurated in 2017 by Dr. Jane Hill and Rowan's Museum Studies students.  Dr. Maria A. Rosado will be on hand to discuss the collections and answer any questions you may have.  ", "Time: 10:00am - 1:00pm\n Location: Bozorth Hall\n Cost: Free\n Explore Rowan's very own radio station headquarters!  WGLS-FM is regional radio service with a potential audience of almost 1.2 million people and has won over 245 national and " +
      ...
      "broadcast a variety of musical, cultural, educational, entertaining and informative programs of interest to the Rowan University and surrounding communities.  ", "Time: 10:00am - 7:00pm\n Location: Rowan University Art Gallery, 301 West High Street, Glassboro NJ\n Cost: Free\n Rowan University art " +
      "Gallery will be producing and presenting an interdisciplinary program that turns a lens on how fashion and textile design is translated " +
      "as a visual arts practice.  This program comes at a time when the arts and design sectors are blending creative principles and crossing over into the " +
      "multi-disciplinary practices.  Fashion design has crossed over into a platform where explorations into gender and cultural identity can reach a broader audience outside" +
      " the mainstream fashion and design sectors.  Artist Heather Ujiie's work speaks directly to issues that are currently relevant in our society: transgender, sexuality, environmental issues, science and technology.", "Time: 10:30am - 12:00pm\n Location: Barnes and Noble, 201 Rowan Boulevard\n Cost: Free\n Barnes and Noble will feature new topical books of interest for students, as well as family PROF related crafts for the whole family to enjoy and take home.  ", "Time: 10:00am - 12:00pm\n Location: Room 105, Harold Wilson Music Building\n Cost: Free\n Come expand your mind doing something relaxing, upbeat and productive.  What is it you say?  Music!  Try instruments, listen " +
      "to informal performances, ask questions about music, and learn about how you can be involved in music even as a non-music major.  if you love music, this is the place for you.  ", "Time: 10:30am - 2:00pm\n Location: Room 107, Harold Wilson Music Building\n Cost: Free\n " +
      ...
      "Family Tailgate menu will feature a variety of salads, sides, grilled entrees and assorted desserts.  (Vegan, vegetarian and gluten-free options are available)", "Time: 11:00am - 2:30pm\n Location: Block Party Vendor Fair\n Cost: Free\n Please stop by for your free flu shot, with proof of insurance card!", "Time: 11:00am - 1:00pm\n Location: Sukkah Hut\n Cost: Free\n " +
      ...
      "and later as a part of Rowan University.  ", "Time: 12::00pm - TBA\n Location: Richard Wacker Stadium\n Cost: Free\n ", "Time: 1:00pm - 1:15pm\n Location: Block Party Vendor Fair\n Cost: Free\n " +
      ...
      "a cappella music and building life-long relationships with other musicians.  ", "Time: 1:00pm - 2:00pm\n Location: Room 107, Engineering Hall\n Cost: Free\n " +
      ...
      "toppings to your ice cream and enjoy a quick presentation about the club, as well as interesting statistics about women in engineering.  ", "Time: 2:00pm - 4:00\n Location: Edelman Fossil Park\n Cost: 7 - Adults, 5 - Children\n " +
  ...
  final desc_sun =["Time: 9:00am - TBA\n Location: Chamberlain Student Center Pit\n Cost: Free\n " +
                ...
                new Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return new GestureDetector( //You need to make my child interactive
                        onTap: () => _detailsDialog(context, desc_fri[index]),
                    child: new Card( //I am the clickable child
                    child: new Column(
                    children: <Widget>[
                    //new Image.network(video[index]),
                    new Padding(padding: new EdgeInsets.all(3.0)),
                    new Text(events_fri[index],
          ...
          child: new Column(
              ...
              children: [
                ...
                new Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return new GestureDetector( //You need to make my child interactive
                        onTap: () => _detailsDialog(context, desc_sat[index]),
                        child: new Card( //I am the clickable child
                            child: new Column(
                                children: <Widget>[
                                  //new Image.network(video[index]),
                                  new Padding(padding: new EdgeInsets.all(3.0)),
                                  new Text(events_sat[index],
          ...
          child: new Column(
              ...
              children: [
                ...
                new Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return new GestureDetector( //You need to make my child interactive
                        onTap: () => _detailsDialog(context, desc_sun[index]),
                        child: new Card( //I am the clickable child
                            child: new Column(
                                children: <Widget>[
                                  //new Image.network(video[index]),
                                  new Padding(padding: new EdgeInsets.all(3.0)),
                                  new Text(events_sun[index],
